...
# 
#### SLD Ratio equals SLD/(SLD+TD)... validity supported yairi and other papers
...
data_for_taxo <- subdata[,c("pct_Block","pct_Prolongation","Mean_RU", "num_SLD","SLD_Ratio","Weighted_SLD","group_for_taxo")]
data_for_taxo <- subdata[,c("num_Block","num_Prolongation","num_PWR","Mean_RU", "num_SLD","SLD_Ratio","Weighted_SLD","group_for_taxo")]


CheckData(data_for_taxo)