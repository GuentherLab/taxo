...
data_for_taxo <- subdata[,c("pct_Block","Mean_RU", "SLD_Ratio","group_for_taxo")]
data_for_taxo <- subdata[,c("num_Block","Mean_RU", "SLD_Ratio","group_for_taxo")]
data_for_taxo <- subdata[,c("num_Prolongation","Mean_RU", "SLD_Ratio","group_for_taxo")]
data_for_taxo <- subdata[,c("num_Prolongation","Mean_RU", "num_SLD","group_for_taxo")]
data_for_taxo <- subdata[,c("num_Prolongation","num_Block", "num_SLD","group_for_taxo")]
data_for_taxo <- subdata[,c("num_PWR","num_Block", "SLD_Ratio","group_for_taxo")]
